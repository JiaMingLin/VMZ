...
--train_data=/4TB/action_data/HMDB51/hmdb51_train01/ \
--test_data=/4TB/action_data/HMDB51/hmdb51_test01 \
--model_name=r2plus1d --model_depth=34 \
--clip_length_rgb=32 --batch_size=4 \
--load_model_path=/4TB/action_data/models/2plus1/r2.5d_d34_l32.pkl \
